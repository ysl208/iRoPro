...
namespace pbd
{
// ConditionGenerator takes landmarks and infers conditions that can be used for pre-/postconditions
...
private:
  ...
  bool IsLandmarkName(const rapid_pbd_msgs::Landmark& landmark, const std::string& name);
